...
const VibePage = ({ token }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-customBackground flex items-center justify-center">
  ...
  if (errorType) {
    return (
      <div className="min-h-screen bg-customBackground flex items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-customBackground flex items-center justify-center p-4 overflow-y-auto">
