   ...
   return (
     <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
       <div className="bg-white rounded-2xl p-6 max-w-2xl w-full shadow-lg my-auto text-left">
         ...
         {/* About Section - EXACT ORIGINAL */}
         <div className="bg-customBackground rounded-xl p-6 space-y-4 mb-6">
           <div className="flex justify-between items-center mb-4">
             <h3 className="text-xl font-semibold text-customPurpleText">About {user?.name}...</h3>
             <button
               onClick={handleEditProfile}
               className="mt-4 px-4 py-2 bg-customPurple text-white rounded-lg text-sm font-medium hover:opacity-90 transition-colors"
             >
               Edit
             </button>
           </div>
           ...
           <div className="space-y-2">
             ...
             {/* Show message if profile incomplete - EXACT ORIGINAL */}
