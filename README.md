...
At its core, BiNx is a mood-first location journal. Instead of just saving a place, you capture the feeling of being there — the atmosphere, the energy, the vibe. Each entry (called a pin) combines a location, a mood, a written note, a photo, and optionally a voice recording, into a single moment in time.
...
BiNx is built around the idea that the best recommendations come from knowing someone's taste deeply, not just their location. The more you use it — the more moments you capture — the more personal the experience becomes.
